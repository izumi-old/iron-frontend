        ...
        return (
            <Card key={this.state.person.id} className={"w-50"}>
                <Card.Body>
                    ...
                    <Button
                        variant={"warning"}
                        disabled={!this.state.person.banned}
                        onClick={() => this.unban(this.state.person)}>
                        Разблокировать
                    </Button>
                    <Button
                        variant={"danger"}
                        disabled={this.state.person.banned}
                        onClick={() => this.ban(this.state.person)}>
                        Заблокировать
                    </Button>
                </Card.Body>
            </Card>
...
export default PersonCardEditable;
